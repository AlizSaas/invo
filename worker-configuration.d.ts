/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: c99abb76ce63e639c1b9c3b069460007)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CODE_SCHEDULAR: DurableObjectNamespace<import("./src/server").CodeEvalutionScheduler>;
		CODE_WORKFLOW: Workflow<Parameters<import("./src/server").CodeEvalutionWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MY_VAR" | "DATABASE_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET">> {}
}
